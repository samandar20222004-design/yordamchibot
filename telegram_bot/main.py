...
async def main():
    ...
    # 4. Doimiy monitoring uchun Web-serverni ishga tushirish (UptimeRobot uchun)
    await start_web_server()

    # 5. APScheduler orqali avtomatik vazifalarni yoqish
    ...
    # Jarayon to'xtab qolmasligi uchun kutish
    try:
        while True:
