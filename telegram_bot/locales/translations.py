...
TRANSLATIONS = {
    "uz": {
        ...
        "health_posts_processing": "• ⚙️ Jarayondagi (processing) postlar: {count}",
        "health_posts_unknown": "• ❔ UNKNOWN delivery (qo'lda tekshiring): {count}",
        "health_ai_errors": "• Ochiq circuit-breaker: {open} | ketma-ket xatolar: {errors}",
        "health_payments_title": "💳 <b>To'lovlar:</b> {status}",
        "health_payments_pending": "• Kutayotgan cheklar: {count}",
        "health_payments_24h": "• 24 soat: tasdiqlangan {approved} | Stars {stars}",
    ...
    "ru": {
        ...
        "health_posts_processing": "• ⚙️ Посты в обработке (processing): {count}",
        "health_posts_unknown": "• ❔ UNKNOWN delivery (проверьте вручную): {count}",
        "health_ai_errors": "• Открытых circuit-breaker: {open} | ошибок подряд: {errors}",
        "health_payments_title": "💳 <b>Платежи:</b> {status}",
        "health_payments_pending": "• Чеков в ожидании: {count}",
        "health_payments_24h": "• 24 часа: подтверждено {approved} | Stars {stars}",
